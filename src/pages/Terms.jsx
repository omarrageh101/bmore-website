  ...
  <p className="text-sm opacity-70 mb-6 hover:text-pink-600 transition-colors duration-200 cursor-pointer">Last updated: 26 Aug 2025</p>
        ...
        <section className="space-y-4 text-left">
          ...
          <p>
            ...
            our Privacy Policy. If you do not agree, please do not use the site.
          </p>
        </section>
        ...
        <section className="space-y-4 text-left">
          ...
          <p>
            ...
            this site are summaries; the product label/packaging is the authoritative source. We make no
        ...
        <section className="space-y-4 text-left">
          ...
          <p>
            ...
            to access and view the site for personal, non-commercial use. You may not copy, modify,
        ...
        <section className="space-y-4 text-left">
          ...
          <p>
            ...
            incidental, consequential, special, or punitive damages, or loss of data or profits, arising
          </p>
        </section>
