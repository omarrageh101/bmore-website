export default function Returns() {
  ...
  <section className="bg-white rounded-2xl shadow p-6 mb-6 hover:shadow-xl hover:scale-105 transition-transform duration-300 cursor-pointer">
  ...
  <section className="bg-white rounded-2xl shadow p-6 hover:shadow-xl hover:scale-105 transition-transform duration-300 cursor-pointer">
